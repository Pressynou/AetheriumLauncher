...
function dlAsync(login = true){
        ...
        if(m.context === 'validate'){
            switch(m.data){
                case 'distribution':
                    ...
                    loggerLaunchSuite.info('Indice de distribution validé.')
                    setLaunchDetails('Chargement des informations de version..')
                    break
                case 'version':
                    setLaunchPercentage(40, 100)
                    loggerLaunchSuite.info('Données de version chargées.')
                    setLaunchDetails('Validation de l\'intégrité des fichiers..')
                    break
                case 'assets':
                    setLaunchPercentage(60, 100)
                    loggerLaunchSuite.info('Validation des fichiers terminée')
                    setLaunchDetails('Validation de l\'intégrité de la bibliothèque..')
                    break
                case 'libraries':
                    setLaunchPercentage(80, 100)
                    loggerLaunchSuite.info('Validation de la bibliothèque terminée.')
                    setLaunchDetails('Validation de l\'intégrité des divers fichiers..')
                    break
                case 'files':
            ...
            if(login && allGood) {
                ...
                const SERVER_JOINED_REGEX = new RegExp(`\\[.+\\]: \\[CHAT\\] ${authUser.displayName} rejoint du jeux`)
                ...
                try {
                    ...
                    setLaunchDetails('Finit. Profitez du serveur!')
                    ...
                    if(distro.discord != null && serv.discord != null){
                        ...
                        proc.on('close', (code, signal) => {
                            loggerLaunchSuite.info('Arrêt de Discord Rich Presence..')
    ...
    refreshDistributionIndex(true, (data) => {
        ...
        loggerLaunchSuite.info('Erreur lors de la récupération d\'une nouvelle copie de l\'index de distribution.', err)
